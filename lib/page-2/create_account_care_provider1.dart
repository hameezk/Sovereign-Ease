...
import 'package:myapp/page-2/create_account_care_provider2.dart';
...
class CreateAccountCareProvider1 extends StatefulWidget {
  const CreateAccountCareProvider1({super.key});

  @override
  State<CreateAccountCareProvider1> createState() =>
      _CreateAccountCareProvider1State();
}

class _CreateAccountCareProvider1State
    extends State<CreateAccountCareProvider1> {
    ...
    if (email.isEmpty ||
      ...
      if (password != confirmPassword) {
        ...
        if (credentials != null) {
          ...
          CareProviderModel careProviderModel = CareProviderModel(
            uid: uid,
            firstName: firstName,
            email: email,
            profilePic:
                'https://firebasestorage.googleapis.com/v0/b/sovereign-ease.appspot.com/o/profilePictures%2Fdoctor-male-skin-type-2-5DK.png?alt=media&token=171414c1-c230-436a-b196-b86e45d881f9',
            lastName: lastName,
          ...
          await FirebaseFirestore.instance
            ...
            (value) {
              ...
              Navigator.pop(context);
              showCustomSnackbar(
                  context: context, content: 'New user created!');
              loggedinUserCareProvider = careProviderModel;
              navigate(
                context,
                CreateAccountCareProvider2(
